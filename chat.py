...
def ask_rag(question):
    ...
    if not results:
        return {
            ...
            "context_size": 0,
            "sources": [],
            "message": "No relevant BIS evidence found."
        }
...
def main():
    ...
    while True:
        ...
        for i, result in enumerate(
            ...
            # Output JSON response for UI integration
            try:
                from Rag_agent import ask_rag
                json_resp = ask_rag(question)
                import json as _json
                print("\nJSON RESPONSE:\n")
                print(_json.dumps(json_resp, indent=4, ensure_ascii=False))
